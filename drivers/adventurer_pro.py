...
class adventurer_pro_ip(weigh_scale_ip):
    """
    IP driver for the Adventurer Pro series weigh scales
    """
    ...
    def __init__(self, hostname, port, timeout=10000):
        ...
        """
        super(adventurer_pro_ip, self).__init__(hostname, port, timeout=timeout)
