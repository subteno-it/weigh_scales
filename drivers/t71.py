...
class t71_ip(weigh_scale_ip):
    """
    IP driver for the T71 series weigh scales
    """
    ...
    def __init__(self, hostname, port, timeout=10000):
        ...
        """
        super(t71_ip, self).__init__(hostname, port, timeout=timeout)
    ...
    def _get_weight(self):
        ...
        value = self.send_command('P').split()
